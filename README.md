...
><p>Spring Boot est utilisé pour la creation des differents APIs qui permet d'etablire la communication  entre l'interface utilisateur et la base de données</p>
